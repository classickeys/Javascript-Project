...
// 2. Determine betting lines
// 2. Collect bet account
// 4. Spin the slot machine
// 5. Check if the user won
// 6. Give/take winnings
// 7. Play again
...
const getNumberOfLines = () => {
  while (true) {
    const numberOfLines = prompt("Enter the number of lines: ");
...
const getBetAmount = (balance) => {
  while (true) {
    ...
    if (isNaN(numberBet) || numberBet <= 0 || numberBet > balance) {
      console.log("Invalid invalid bet, try again");
    } else {
      return numberBet;
    }
  }
